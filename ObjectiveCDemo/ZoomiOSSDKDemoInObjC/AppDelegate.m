...
// This is not a neccesary action. In real use cases, the SDK should be alerted of app events. For example, in - (void)applicationWillTerminate:(UIApplication *)application, [[MobileRTC sharedRTC] appWillTerminate] should be called.
...
- (void)onMobileRTCAuthReturn:(MobileRTCAuthError)returnValue {
    switch (returnValue) {
        ...
        case MobileRTCAuthError_KeyOrSecretEmpty:
            NSLog(@"SDK key/secret was not provided. Relpace sdkKey and sdkSecret at the top of this file with your SDK key/secret.");
            break;
